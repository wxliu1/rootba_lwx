...
#NUM_CORES=1
NUM_CORES=13 # added by wxliu on 2024-4-15
...
#git submodule sync --recursive # because external libraries are downloaded, comment by wxliu on 2024-4-15
#git submodule update --init --recursive # because external libraries are downloaded, comment by wxliu on 2024-4-15
